      ...
      <main className="grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start">
          <div className="lg:col-span-8">
            {isLoading ? (
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 flex flex-col justify-center items-center">
                 ...
                 <span className="text-gray-500 font-medium text-lg">Loading your harvest...</span>
              </div>
            ) : cartItems.length === 0 ? (
                  ...
                  <li key={item.id} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row items-center gap-6">
                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      <div className="flex justify-between sm:items-start gap-4 flex-col sm:flex-row">
                        <div>
                          <Link href={`/products/${item.id}`} className="hover:text-green-700 transition-colors">
